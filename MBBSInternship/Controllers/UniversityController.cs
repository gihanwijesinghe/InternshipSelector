...
namespace MBBSInternship.Controllers
{
    public class UniversityController : Controller
    {
        ...
        {
            var internshipContext = _context.Universities.Include(u => u.District);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DistrictId")] University university)
        {
            ...
            ViewData["DistrictId"] = new SelectList(_context.Districts, "Id", "Id", university.DistrictId);
            return View(university);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DistrictId")] University university)
        {
            if (id != university.Id)
            {
                return NotFound();
